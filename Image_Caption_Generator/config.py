...
config = {
    ...
    # Make sure you put that last slash(/)
    ...
    'model_load_path': 'model_data/model_inceptionv3_epoch-09_train_loss-2.4386_val_loss-3.0703.hdf5',
    # 'model_load_path': 'model_data/model_inceptionv3_epoch-20_train_loss-2.4050_val_loss-3.0527.hdf5',
    'num_of_epochs': 30,
    'max_length': 40,
    # This is set manually after training of model and required for test.py
    'batch_size': 16,
    'beam_search_k': 3,
...
#
# def get_path(item):
#     return get_absolute_path(config[item])
